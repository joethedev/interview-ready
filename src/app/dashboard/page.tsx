...
import { Play, Target, Brain, AlertTriangle, Calendar, TrendingUp, Sparkles } from "lucide-react";

// Fake data
const stats = [
  { label: "Mock Interviews", value: 12, icon: Play, change: "+3 this week" },
  { label: "Average Score", value: "78%", icon: TrendingUp, change: "+5% improvement" },
  { label: "Questions Practiced", value: 156, icon: Brain, change: "24 this week" },
  { label: "Weak Areas", value: 4, icon: AlertTriangle, change: "2 improved" },
];

const recentSessions = [
  { id: 1, name: "Frontend Interview #3", date: "Jan 25, 2026", score: 85, status: "Completed" },
  { id: 2, name: "System Design Practice", date: "Jan 24, 2026", score: 72, status: "Completed" },
  { id: 3, name: "Behavioral Questions", date: "Jan 23, 2026", score: null, status: "In Progress" },
  { id: 4, name: "React Hooks Deep Dive", date: "Jan 22, 2026", score: 90, status: "Completed" },
];
      ...
      <main className="container py-8 space-y-8">
        ...
        <section>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => (
              <Card key={stat.label} className="border border-border shadow-card">
